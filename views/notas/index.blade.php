    ...
    <section class="section">
        ...
        <div class="section-body"> 
			<div class="section-header">
				<h4 class="page__heading">Notas &#160; {{ session('activo') }}</h4>
			</div>
			...
			<br><br>
				...
				<div>
					...
					<a class="btn btn-outline-primary btn-sm" title="Cargar Notas" href="notas/show">
						<i class="fa fa-edit fa-sm" aria-hidden="true"></i> Cargar Notas</a>  
								...
								<table id="notas" style="width: 100%;" class="table-sm table-striped mt-2">
									...
									@endphp
										...
										<tr>	
											...
											@if (!empty($nota->matricula->seccion->nombre_seccion))
											...
											<br> {{ $nota->matricula->grupo->nombre }}</td>
									 		@else 
											<td>{{ $nota->anioasignatura->asignatura->abreviado }}
												@if ($nota->anioasignatura->docente_id!=null)	
											...
											<div>
												...
												<a class="btn btn-outline-primary btn-sm" title="Cargar Notas" href="{{ route('notas.edit',$nota->nota_id) }}">
