...
<b>
   ...
   <br>
    <div style="text-align: center"> CONSTANCIA DE INSCRIPCIÓN </div>
</b>
    ...
    <p> &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
        ...
        la cédula de identidad Nº{{$matricula->alumno->cedula}}, fue inscrito(a) en la institución 
        para cursar {{$matricula->grado->nombre_grado}}  año de Educación Media General.
    </p>
...
$dompdf->stream('Constancia de Inscripcion'.$nombre_constancia.'.pdf',array('Attachment'=>false));
@endphp
